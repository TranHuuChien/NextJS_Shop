...
import {Box, FormHelperText, InputLabel, TextareaAutosize, TextareaAutosizeProps, useTheme} from "@mui/material";
...
const CustomTextArea = (props: TCustomTextArea) => {
    ...
    return (
        <Box>
            <InputLabel sx={{ fontSize: '15px', marginBottom: '4px', display: 'block'
