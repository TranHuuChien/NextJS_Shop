...
const Popover: React.FC<PopoverProps> = ({ isOpen: isOpenProp, setIsOpen: setIsOpenProp,
                                             children, position = "down-center", ...props }) => {
    ...
    const content = children[1] ? React.cloneElement(children[1], {
